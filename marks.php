...
<body>
    <div class="content">
        <a href="results.php" class="rank">Rank List :</a>
        ...
        <div class="cont">
           <?php
            ...
            ?>
        <h2 class="c2">You Are Filling Out, <?php echo $_SESSION['class']; ?> Marks</h2>
        <form onsubmit="return validate()" action="marks.php" method="Post">
            <h3>Student Marks</h3>
